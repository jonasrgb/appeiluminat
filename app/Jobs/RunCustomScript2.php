...
class RunCustomScript2 implements ShouldQueue
{
    ...
    {
        $this->collectionId = "624000663891";  // ID-ul colecției
        $this->shopDomain = "powerleds-ro.myshopify.com";
    }
    ...
    public function handle()
    {
        try {
            ...
            \Log::info('Products removal job completed successfully powerleds');
        } catch (\Exception $e) {
