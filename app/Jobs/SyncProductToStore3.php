...
class SyncProductToStore3 implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        $config = [
            ...
            'location_id' => env('LOCATION_LUSTRELED'),
        ];  
        ...
        Log::debug('🌍 ENV STORE_URL_LUSTRELED: ' . env('STORE_URL_LUSTRELED'));
        ...
        Log::info("🛒 Store2: Product creation response", $responseData);
        ...
        foreach ($images as $image) {
            ...
            try {
                ...
                if (!empty($body['data']['productCreateMedia']['media'][0]['status'])) {
                    ...
                    Log::info("✅ Image uploaded successfully lustreled:");
                } else {
                    //Log::warning("⚠️ Image upload issue for Store2: ", $body);
                    Log::warning("⚠️ Image upload issue for lustreled:");
                }
        ...
        foreach ($publicationIds as $publicationId) {
            ...
            try {
                $response = Http::withHeaders([
                    ...
                    'Content-Type' => 'application/json'
                ])->post("https://" . env('STORE_URL_LUSTRELED') . "/admin/api/2024-01/graphql.json", [
                    'query' => $mutation,
                    'variables' => $variables
                ]);
